export const enum LogCode {
    ...
    MRCH_CNTRL__MRCH_NT_EX__ERR = 'MERCHANT_IS_NOT_EXIST',
    SRV_CNTRL__PMCH_NT_EX__ERR = 'PAYMENT_CHANNEL_IS_NOT_EXIST',
}
...
export const enum LogCodeId {
    ...
    MRCH_CNTRL__MRCH_NT_EX__ERR = 10000009,
    SRV_CNTRL__PMCH_NT_EX__ERR = 10000010,
}
